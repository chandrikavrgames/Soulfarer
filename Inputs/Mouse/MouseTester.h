...
#include "MouseTester.generated.h"


UCLASS()
class SKYFARER_C_API AMouseTester : public AGenericRigPawn
{
	GENERATED_BODY()
...
public:
	...
	//FVector(0,-1,-1);
	UPROPERTY(EditAnywhere, Category = MouseTester)
	...
	UPROPERTY(VisibleAnywhere, Category = MouseTester)
...
private:
	...
	//mouse from rig inputs
	void SetXVelocityRig();
	void SetYVelocityRig();
